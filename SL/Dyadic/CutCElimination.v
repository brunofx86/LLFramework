...
Theorem CutC i j w h P M N B : CutH w h -> CutW w -> complexity P = w -> S h = i + j ->
 LL2 i |-- P::B; M ->
 LL2 j |-- B; (! dual P)::N ->
 LL2 |-- B; M ++ N.
...
Theorem CutC' i j w h P M B : CutH w h -> CutW w -> complexity P = w -> S h = i + j ->
 LL2 i |-- P::B; M ->
 LL2 j |-- B; [! dual P] ->
 LL2 |-- B; M.
Proof with sauto; try dualSimpl.   
