...
Require Import LL.SL.Monadic.StructuralRules.
...
Proof with sauto.
  ...
  induction n;intros...
  + inversion H...
      apply LL1weakening with (B:=B) (M:=L)...
      LL1init A.
      apply LL1weakening with (B:=B) (M:=[1])...
      apply LL1weakening with (B:=B) (M:=L)...
      LL1top M.
  + inversion H...
      -
      ...
      LL1init A.
      -
      apply LL1contraction with (B:=B) (M:=L)...
