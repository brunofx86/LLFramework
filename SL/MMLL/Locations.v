...
Require Export LL.SL.MMLL.Syntax.
Require Export LL.SL.MMLL.Signature.
...
End SubExpSets.
 ...
 Global Hint Unfold SetU SetL SetK SetK4 LtX NoLtX PlusT Loc first second: core.  
...
(* About second *)
 ...
 Ltac solveSignature1 := try
  match goal with
  | [ H1: UNoDSigMMLL, H2: md _ = true |- _ ] => rewrite allNoD in H2;discriminate H2 
...
Section Properties.
  ...
  Lemma locSetK1 a F: u a = true -> SetU [(a, F)].
...
(*   Lemma locSetK2 i F: i <> loc -> ~ SetK i [(loc, F)]. *)
 ...
 (*  Lemma locSetD F:  ~ SetD md true [(loc, F)].
  Proof with sauto.
  intro.
  inversion H...
  solveLocation.
 ...
 *)
 ...
 Qed.
  ...
  Qed.
    ...
    Lemma SetTKClosure i K  : mt i = true -> LtX i K -> SetT K. 
  Proof with sauto.
  intros.
  induction K;intros...
  apply Forall_nil. 
  ...
  Qed.
    ...
    Lemma SetUKClosure i K  : u i = true -> LtX i K -> SetU K. 
  Proof with sauto.
  intros.
  induction K;intros... 
  inversion H0...
 ...
 Lemma SetK4Closure i K  : m4 i = true -> LtX i K -> SetK4 K. 
  Proof with sauto.
  induction K;intros... 
  inversion H0...
  apply Forall_cons...
 ...
 *)
 ...
 Lemma SetK4In a K: SetU K -> In a K -> u (fst a) = true.
  Proof with sauto.
  intros.
...
(* Lemmata about SetK *) 
  ...
  Lemma SetKPlusT K: SetK K ->  SetK (PlusT K).
  Proof with sauto.
 ...
 apply IHK...
  Qed.
    ...
    Lemma SetK4PlusT K: SetK4 K ->  SetK4 (PlusT K).
  Proof with sauto.
  induction K;simpl;intros;auto.
 ...
 apply IHK...
  Qed.
   ...
   Lemma SetK4PlusT' K: SetK4 (PlusT K)  -> SetK4 K.
  Proof with sauto.
  induction K;simpl;intros;auto.
   apply Forall_cons...
 ...
 Lemma SetKPlusT' K: SetK (PlusT K)  -> SetK K.
  Proof with sauto.
  induction K;simpl;intros;auto.
   apply Forall_cons...
    apply  Forall_inv in H...
 ...
 Lemma PlusTSetU K: SetU (PlusT K) -> SetU K.
  ...
  Lemma SetLPlusT K: SetL K ->  SetL (PlusT K).
  Proof with sauto.
  induction K;simpl;intros;auto.
    destruct a as [p F].
    inversion H...
 ...
 Lemma PlusTSetL K: SetL (PlusT K) -> SetL K.
  Proof with sauto.
  induction K;simpl;intros;auto.
    apply Forall_cons...
    apply  Forall_inv in H...
...
Qed.
 ...
 Qed. 
  ...
  Lemma SetK4Loc i K  : i <> loc -> SetK4 K -> In loc (first K) -> False. 
  Proof with sauto.
  induction K;simpl;intros.
  contradiction.
  destruct H1.
...
Lemma unboundedEmpty K : getU K = [] -> getU K = [] /\ Permutation (getL K) K /\ SetL K.
 ...
 Qed.
  ...
  Lemma SetK4Destruct K : SetK4 K -> SetK4 (getU K) /\ SetK4 (getL K).
  Proof with sauto.
  intros.
...
Proof with sauto.
 ...
 Lemma SetK4LocEmpty C : LtX loc C -> SetK4 C -> C = []. 
 Proof with sauto.
 induction C;intros...
 inversion H...
 inversion H0...
  ...
  Proof with subst;auto.
    ...
    *
      ...
      - eapply IHC4 with (CN:=a::CN) (CN':=CN') in H0;
        [sauto | solveLocation | 
         rewrite H1;symmetry;rewrite <- app_comm_cons;
         apply Permutation_cons_app;auto].
         checkPermutationCases H4.
         + 
           eexists (a::x0), x1, x4, x3.
           split;auto.
 ...
 SetK4 C4 -> SetK4 C4' -> SetK CK -> SetK CK' -> 
  ...
  intros.
    ...
    *
      ...
      -  assert(Permutation  (a :: C4 ++ (a0 :: CK) ++ CN)  (a0 :: C4 ++ (a :: CK) ++ CN)) by perm.
         ...
         rewrite <- H6 in H5.
         apply IHCK in H5... 
         eexists (a0::x1), x2, x3, x4, x5, x6, x7...
         rewrite H4...
         rewrite H3.
         rewrite H8...
         inversion H1...
         ...
         rewrite <- H6 in H5.
         apply IHCK in H5... 
         eexists x1, (a0::x2), x3, x4, x5, x6, x7...
         rewrite H4...
         rewrite H3.
...
Global Hint Resolve SetUPlusT locSetU locSetT SetUKClosure SetK4Closure getUtoSetU getLtoSetL: ExBase.
...
Ltac solveSignature2 :=
 match goal with
  | [ H: _ ?s ?b ?K |- _ ?s ?b (getU ?K)] => apply SetK4Destruct in H;sauto
  | [ H: _ ?s ?b ?K |- _ ?s ?b (getL ?K)] => apply SetK4Destruct in H;sauto

| [ H: _ ?s ?b ?K, H2: Permutation (getU ?K) (?K2 ++ _) |- _ ?s ?b ?K2] => 
   let H' := fresh "H" in
          apply SetK4Destruct in H; destruct H as [H H'];rewrite H2 in H;solveSignature2
 | [ H: _ ?s ?b ?K, H2: Permutation (getU ?K) (_ ++ ?K2) |- _ ?s ?b ?K2] => 
   let H' := fresh "H" in
          apply SetK4Destruct in H; destruct H as [H H'];rewrite H2 in H;solveSignature2
