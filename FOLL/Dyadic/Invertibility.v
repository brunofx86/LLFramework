...
Proof with sauto.
  induction n ;intros...
   ...
   - inversion H...
    ...
    + checkPermutationCases H1.
        rewrite H4...
        refine (heightGeqLL2N H2 _)...
        rewrite H3. rewrite <- H1. 
        refine (heightGeqLL2N H2 _)...
    + checkPermutationCases H1.
        LLpar F G x.
        eapply IHn.
        eapply exchangeLL2N with (B1:=B) (L1:=  F :: G ::⊥ :: x)... 
        rewrite <- H1...
   + checkPermutationCases H1.
       checkPermutationCases H1.
        LLtensor F G x0 N .
  ...
  induction n ;intros...
   ...
   - inversion H...
    ...
    + checkPermutationCases H1.
        ...
        eapply exchangeLL2N with (B1:=B) (L1:=  F :: G ::F0 :: x)... 
        eapply IHn. 
        rewrite perm_swap. rewrite <- H1...
    + checkPermutationCases H1.
        LLright F0 G0 (F::G::x). rewrite H3...
        eapply exchangeLL2N with (B1:=B) (L1:=  F :: G ::G0 :: x)... 
        eapply IHn. 
        rewrite perm_swap. rewrite <- H1...
    + checkPermutationCases H1.
        LLwith F0 G0 (F::G::x). rewrite H4...
        eapply exchangeLL2N with (B1:=B) (L1:=  F :: G ::F0 :: x)... 
        2: eapply exchangeLL2N with (B1:=B) (L1:=  F :: G ::G0 :: x)... 
        1-2: eapply IHn. 
        1-2: rewrite perm_swap. 1-2: rewrite <- H1...
    + checkPermutationCases H1.
    ...
    + checkPermutationCases H1.
       ...
       { LLpar F0 G0 (F::G::x). rewrite H3...
          eapply exchangeLL2N with (B1:=B) (L1:=  F :: G ::F0 :: G0::x)... 
          eapply IHn. 
          eapply exchangeLL2N with (B1:=B) (L1:=F0 :: G0::(F ⅋ G) ::x)... 
            rewrite <- H1... }
   + checkPermutationCases H1.
       checkPermutationCases H1.
        LLtensor F0 G0 (F::G::x0) N . rewrite H4... rewrite <- H5...
        eapply exchangeLL2N with (B1:=B) (L1:=  F :: G ::F0 ::x0)... 
        eapply IHn. 
        rewrite perm_swap. rewrite <- H1...
        LLtensor F0 G0 M0 (F::G::x0) . rewrite H4... rewrite <- H5...
        eapply exchangeLL2N with (B1:=B) (L1:=  F :: G ::G0 ::x0)... 
        eapply IHn. 
        rewrite perm_swap. rewrite <- H1...
   + checkPermutationCases H1.
   ...
   + checkPermutationCases H1.
       LLexists t FX (F::G::x).
       rewrite H5... 
       eapply exchangeLL2N with (B1:=B) (L1:=  F :: G ::FX t ::x)... 
         eapply IHn. 
        rewrite perm_swap. rewrite <- H1...
   + checkPermutationCases H1.
       LLforall FX (F::G::x).
       rewrite H4... 
       eapply exchangeLL2N with (B1:=B) (L1:=  F :: G ::FX x0 ::x)... 
         eapply IHn. 
        rewrite perm_swap. rewrite <- H1...
   + LLcopy F0.
        eapply exchangeLL2N with (B1:=B) (L1:=  F :: G ::F0 ::M)... 
        eapply IHn.
        rewrite perm_swap... 
Qed.
  ...
  induction n ;intros...
   ...
   - inversion H...
    ...
    + checkPermutationCases H1.
        LLpar F0 G x.  
          eapply IHn. 
          eapply exchangeLL2N with (B1:=B) (L1:=F0 :: G:: ? F::x)... 
            rewrite <- H1... 
   + checkPermutationCases H1.
       checkPermutationCases H1.
        LLtensor F0 G x0 N .  
...
Proof with sauto.
  induction n ;intros...
   ...
   - inversion H...
    ...
    + checkPermutationCases H1.
       { inversion H4...
          rewrite H5. refine (heightGeqLL2N H2 _)...   }
    ...
    + checkPermutationCases H1.
       LLpar F0 G0 (F::x). rewrite H3...
        eapply exchangeLL2N with (B1:=B) (L1:=  F :: F0 :: G0::x)... 
        eapply IHn with (F:=F) (G:=G). 
          eapply exchangeLL2N with (B1:=B) (L1:=F0 :: G0::(F & G) ::x)... 
            rewrite <- H1... 
   + checkPermutationCases H1.
   ...
   - inversion H...
    ...
    + checkPermutationCases H1.
       { inversion H4...
          rewrite H5. refine (heightGeqLL2N H3 _)... }  
    ...
    + checkPermutationCases H1.
       LLpar F0 G0 (G::x). rewrite H3...
        eapply exchangeLL2N with (B1:=B) (L1:=  G :: F0 :: G0::x)... 
        eapply IHn with (F:=F) (G:=G). 
          eapply exchangeLL2N with (B1:=B) (L1:=F0 :: G0::(F & G) ::x)... 
            rewrite <- H1... 
   + checkPermutationCases H1.
...
Proof with sauto.
  induction n ;intros...
   ...
   - inversion H...
    ...
    + checkPermutationCases H2.
       LLpar F G (FX x::x0). rewrite H4...
        eapply exchangeLL2N with (B1:=B) (L1:=  FX x :: F :: G::x0)... 
        eapply IHn... 
          eapply exchangeLL2N with (B1:=B) (L1:=F:: G::∀{ FX} ::x0)... 
            rewrite <- H2... 
   + checkPermutationCases H2.
       checkPermutationCases H2.
   ...
   + checkPermutationCases H2.
       { inversion H5...
          pose proof (H4 x H0).
          rewrite H6... refine (heightGeqLL2N H1 _)...  }
