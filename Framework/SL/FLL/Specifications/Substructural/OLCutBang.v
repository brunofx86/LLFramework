 ...
 (** Main theorem showing that it is possible to fins a proof with
  ...
  Proof with sauto.
   ...
   { checkPermutationCases H1.
       solvePolarity.
      pose proof (onlyAtomsLinearB PosN H0 (symmetry H1) )...
  ...
  cut(False);intros...
   ...
   { checkPermutationCases H4.
       solvePolarity.
      pose proof (onlyAtomsLinearB PosM H3 (symmetry H4) )...
 ...
 Qed.                   
  ...
  induction n ; induction h using lt_wf_ind; intros *;intros isFB isFN Hh.
    ...
    * inversion Hh...
       ...
       pose proof (onlyAtomsLinearB isFN H0 H1 )...
      inversion H2;sauto;solvePolarity.  
       inversion H8...
      LFocus. solveLL.
