...
Definition QuantifierUniformR
  C FX: Prop :=
  FLLS theory Gamma Delta ( DW (rq_rgtBody (rulesQ C) FX)) ->
  uniform FX. 

Definition QuantifierUniformL
  C FX: Prop :=
  FLLS theory Gamma Delta ( DW (rq_lftBody (rulesQ C) FX)) ->
  uniform FX.
...
Definition UniformQ (lab: qcon) (s:Side) : Prop :=
  match s with
    | Left => forall FX, QuantifierUniformL lab FX
    | Right => forall FX,  QuantifierUniformR lab FX
end.
...
Definition wellUniformQ: Prop :=
  forall Theory Gamma Delta (lab: qcon) (s:Side),
  UniformQ Theory Gamma Delta lab s.
...
Global Hint Unfold wellFormedC wellFormedU wellFormedB wellFormedQ  wellUniformQ wellFormedTheory: core .
