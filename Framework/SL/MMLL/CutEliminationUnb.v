...
LLPerm(B++[]++[]).
              eapply @InvTensor with (B:=B) (C:=[]) (D:=[])...
                apply Derivation1.
                apply MLLNtoSeq in H14... LLExact H14.
             ...
             - 
              ...
              eapply @InvTensor with (B:=B) (C:=[]) (D:=[])...
              apply Derivation1.
              apply MLLNtoSeq in H10...    LLExact H10.
...
*  destruct(posOrNeg F).
   2:{ inversion H7;CleanContext...
     ...
     LLPerm (B++[]++[]).
               eapply @InvTensorC with (F:=F0) (G:=G) (i:=i0) (B:=B) (C:=[]) (D:=[])...
               apply Derivation1.
               apply MLLNtoSeq in H11... LLExact H11.
...
LLPerm (B++[]++[]).
               eapply @InvTensorT with (F:=F0) (G:=G) (B:=B) (C:=[]) (D:=[])...
               apply Derivation1.
               apply MLLNtoSeq in H9... LLExact H9.
 ...
 *  apply posLDestruct in H4...
   ...
   inversion H...
   inversion Hj...
   apply MLLNtoSeq in H5. LLExact H5. 
   rewrite <- H7.
  ...
  --  apply in_app_or in H3...
      ...
      + inversion H...
        ...
        rewrite Nat.lt_succ_pred with (z:=0%nat)...
          ...
          assert(Hs: |-- B; M; (UP [F]))...
          clear Cut.
          apply MLLStoSeqN in Hs.
          destruct Hs as [x Hs].
          apply InvBangT in Hj...
         apply MLLStoSeqN in Hj.
          destruct Hj as [y Hj].
