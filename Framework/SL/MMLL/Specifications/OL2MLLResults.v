...
Lemma PositiveAtomREOLFormulaB a L : posAtomFormulaL (REncodeB a L) -> isOLFormulaL L.
Proof with sauto.
  intros.
  induction L;intros... 
  inversion H...
...
Lemma isOLREncodeB : forall a L, isOLFormulaL L -> posAtomBFormulaL (REncodeB a L).
Proof with sauto.
  intros.
  induction L; simpl... 
  constructor. simpl.
